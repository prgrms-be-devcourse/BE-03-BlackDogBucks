...
class ItemTest {
    ...
    void constructor_create_success() {
        ...
        String engName = "Iced Caffe Americano";
        int price = 4500;
    ...
    @DisplayName("생성 - Item() - engName이 Empty 이면 생성에 실패한다.")
    @Test
    void constructor_create_engName_empty_fail() {
        //given
        ItemCategory itemCategory = createCategory();
    ...
    private static ItemCategory createCategory() {
        ...
        String itemCategoryEngName = "Reserve Espresso";

        ItemCategory itemCategory = ItemCategory.builder()
            .name(itemCategoryName)
            .engName(itemCategoryEngName)
            .itemType(beverage)
            .build();
        return itemCategory;
    }
